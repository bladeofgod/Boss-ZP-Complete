...
public class MsgReacNewJobAdapter extends BaseQuickAdapter<JobBean, BaseViewHolder> {
    public MsgReacNewJobAdapter(@Nullable List<JobBean> data) {
        super(R.layout.rv_item_msg_reac_job,data);
    }
